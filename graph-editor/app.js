...
if (typeof _jhrcek$graph_editor$Main$main !== 'undefined') {
    _jhrcek$graph_editor$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Types.DragMsg":{"args":[],"tags":{"DragEnd":["Mouse.Position"],"DragAt":["Mouse.Position"],"DragStart":["Graph.NodeId","Mouse.Position"]}},"Types.NodeText":{"args":[],"tags":{"NodeText":["Maybe.Maybe Types.BBox","String"]}},"Types.EditState":{"args":[],"tags":{"EditingNodeLabel":["Types.GraphNode"],"EditingEdgeLabel":["Types.GraphEdge"],"CreatingEdge":["Graph.NodeId","Mouse.Position"],"EditingNothing":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Types.Msg":{"args":[],"tags":{"EndNodeOfEdgeSelected":["Graph.NodeId"],"NodeLabelEditStart":["Types.GraphNode"],"DeleteEdge":["Graph.NodeId","Graph.NodeId"],"NodeLabelEdit":["String"],"SetBoundingBox":["Types.BBox"],"NodeLabelEditConfirm":[],"ToggleHelp":["Bool"],"SetMode":["Types.EditorMode"],"EdgeLabelEdit":["String"],"UnselectStartNodeOfEdge":[],"CreateNode":["Mouse.Position"],"ToggleAbout":["Bool"],"WindowResized":["Window.Size"],"NodeDrag":["Types.DragMsg"],"EdgeLabelEditConfirm":[],"StartNodeOfEdgeSelected":["Graph.NodeId"],"NoOp":[],"PreviewEdgeEndpointPositionChanged":["Mouse.Position"],"EdgeLabelEditStart":["Types.GraphEdge"],"DeleteNode":["Graph.NodeId"]}},"Types.EditorMode":{"args":[],"tags":{"DeletionMode":[],"EditMode":["Types.EditState"],"MoveMode":[]}},"Types.EdgeLabel":{"args":[],"tags":{"EdgeLabel":["Maybe.Maybe Types.BBox","String"]}}},"aliases":{"Graph.NodeId":{"args":[],"type":"Int"},"Types.GraphEdge":{"args":[],"type":"Graph.Edge Types.EdgeLabel"},"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Graph.Edge":{"args":["e"],"type":"{ from : Graph.NodeId, to : Graph.NodeId, label : e }"},"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"},"Types.BBox":{"args":[],"type":"{ x : Float , y : Float , width : Float , height : Float , elementId : String }"},"Graph.Node":{"args":["n"],"type":"{ id : Graph.NodeId, label : n }"},"Types.NodeLabel":{"args":[],"type":"{ nodeText : Types.NodeText, x : Int, y : Int }"},"Types.GraphNode":{"args":[],"type":"Graph.Node Types.NodeLabel"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
